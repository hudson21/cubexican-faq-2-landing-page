...
export default function Privacy() {
  return (
    <div className="policy-container">
      ...
      <p className="sec-text-pad lead">Personal Information We Collect</p>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          refer to this information as <strong>“Order Information.”</strong>
        </li>
      </ul>
      ...
      <p className="sec-text-pad lead">Sharing Your Personal Information</p>
      ...
      <p className="sec-text-pad lead">Behavioural Advertising</p>
      <p>
      ...
      <p className="sec-text-pad lead">Do Not Track</p>
      ...
      <p className="sec-text-pad lead">Your Rights</p>
      <p>
      ...
      <p className="sec-text-pad lead">Data Retention</p>
      <p>
      ...
      <p className="sec-text-pad lead">Minors</p>
      <p>The Site is not intended for individuals under the age of 14.</p>

      <p className="sec-text-pad lead">Changes</p>
      <p>
      ...
      <p className="sec-text-pad lead">Contact Us</p>
      <p>
